  ...
  return (
    <Layout>
      ...
      <section className="cards">
        <a href="https://tdudkowski.usermd.net/files/tuitam/od_slowa_do_slowa_karta_zadan_1.pdf"><Img fluid={data.karta1_okladka.childImageSharp.fluid} className="cover" alt="okładka karty 1" /><div>Karta pracy 1 "Od Adama i Ewy" (2 strony, 5 zadań)</div></a>
        <a href="https://tdudkowski.usermd.net/files/tuitam/od_slowa_do_slowa_karta_zadan_2.pdf"><Img fluid={data.karta2_okladka.childImageSharp.fluid} className="cover" alt="okładka karty 2" /><div>Karta pracy 2 "Po kocich ścieżkach w mieście" (2 strony, 5 zadań)</div></a>
        <a href="https://tdudkowski.usermd.net/files/tuitam/od_slowa_do_slowa_karta_zadan_3.pdf"><Img fluid={data.karta3_okladka.childImageSharp.fluid} className="cover" alt="okładka karty 3" /><div>Karta pracy 3 "Mitologia w małym palcu" (2 strony, 7 zadań)</div></a>
        <a href="https://tdudkowski.usermd.net/files/tuitam/od_slowa_do_slowa_karta_zadan_4.pdf"><Img fluid={data.karta4_okladka.childImageSharp.fluid} className="cover" alt="okładka karty 4" /><div>Karta pracy 4 "Znam wrocławskich legend wiele" (2 strony, 6 zadań)</div></a>
        <a href="https://tdudkowski.usermd.net/files/tuitam/od_slowa_do_slowa_karta_zadan_5.pdf"><Img fluid={data.karta5_okladka.childImageSharp.fluid} className="cover" alt="okładka karty 5" /><div>Karta pracy 5 "Od słowa do słowa gra miejska po Wrocławiu" (4 strony, 33 zadania)</div></a>
