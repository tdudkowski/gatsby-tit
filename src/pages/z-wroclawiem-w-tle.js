    ...
    return (
        <Layout>
            ...
            <section className="imgandtxt">
                <a href="http://tdudkowski.usermd.net/files/tuitam/afisz-z_wroclawiem_w_tle-marzec.jpg">
                    <Img fluid={data.afisz_marzec.childImageSharp.fluid} className="cover" alt="afisz marzec" />
                </a>
                <div>
                    <p>
...
export const pageQuery = graphql`
  query {
    ...
    afisz_marzec: file(relativePath: { eq: "afisz-z_wroclawiem_w_tle-marzec.jpg" }) {
        id
        childImageSharp {
          fluid(maxWidth: 640) {
            ...GatsbyImageSharpFluid
