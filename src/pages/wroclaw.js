...
<Img fluid={data.wroclawrynek2.childImageSharp.fluid} className="cover" alt="okładka przewodnika" />
<ul>
	<li>
...
export const pageQuery = graphql`
  query {
    wroclawrynek1: file(relativePath: { eq: "wroclaw-rynek1.jpg" }) {
      id
      childImageSharp {
        fluid(maxWidth: 800) {
    ...
    wroclawrynek2: file(relativePath: { eq: "wroclaw-rynek2.jpg" }) {
        id
        childImageSharp {
          fluid(maxWidth: 800) {
            ...GatsbyImageSharpFluid
